...
export function InstallationForm({ formId, mode, defaultValues, onSubmit }: { formId: string; mode: 'create' | 'edit'; defaultValues: InstallationFormValues; onSubmit: (values: InstallationFormValues) => void | Promise<void> }) {
